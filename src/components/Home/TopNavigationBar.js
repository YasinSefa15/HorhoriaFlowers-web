...
export default function TopNavigationBar() {
    ...
    return (
        <>
            <nav
                className="navbar  bg-secondary-emphasis"
                style={{
                    paddingTop: "20px",
                    paddingLeft: "20px",
                    paddingRight: "20px",
                ...
                <div className="container-fluid">
                    ...
                    <div className="dropdown" onMouseEnter={() => setIsDropdownOpen(true)}
                         onMouseLeave={() => setIsDropdownOpen(false)} style={{position: "relative"}}>
                    ...
                    >
                        <input
                            className="form-control me-2 col-2 col-sm-6"
                            type="search"
                        ...
                        />
                        <NavLink to={"/products?title=" + search} className="btn btn-outline-primary col-1">
                    ...
                    {user ? (
                        <>
                            ...
                            <NavLink className="navbar-brand" to="/" onClick={(e) => {
                                logOut();
                            }}>
